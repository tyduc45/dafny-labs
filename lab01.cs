// Dafny program lab01.dfy compiled into C#
...
// Command-line arguments: run --no-verify e:\cpp_review\dafny_lab\labs\lab01.dfy
// lab01.dfy
...
datatype shape = Rectangle(height: nat, width: nat) | Square(side: nat) | Triangle(base: nat, height: nat)
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger distSquared(_System._ITuple2<BigInteger, BigInteger> v) {
      return (((v).dtor__0) * ((v).dtor__0)) + (((v).dtor__1) * ((v).dtor__1));
    }
    public static BigInteger dotProduct(_System._ITuple2<BigInteger, BigInteger> u, _System._ITuple2<BigInteger, BigInteger> v)
    {
      return (((u).dtor__0) * ((v).dtor__0)) + (((u).dtor__1) * ((v).dtor__1));
    }
    public static bool perpendicular(_System._ITuple2<BigInteger, BigInteger> u, _System._ITuple2<BigInteger, BigInteger> v)
    {
      if ((__default.dotProduct(u, v)).Sign == 0) {
        return true;
      } else {
        return false;
      }
    ...
    public static bool inRange(BigInteger lo, BigInteger x, BigInteger hi)
    {
      if (((lo) <= (x)) && ((x) <= (hi))) {
        return true;
      } else {
    ...
    public static BigInteger withTax(BigInteger cents) {
      BigInteger _0_tax = Dafny.Helpers.EuclideanDivision(cents, new BigInteger(10));
      return (cents) + (_0_tax);
    }
    public static _Ilight next(_Ilight l) {
      _Ilight _source0 = l;
      {
        if (_source0.is_Red) {
    ...
    public static BigInteger area(_Ishape s) {
      _Ishape _source0 = s;
      {
        if (_source0.is_Rectangle) {
          BigInteger _0_height = _source0.dtor_height;
          BigInteger _1_width = _source0.dtor_width;
          return (_0_height) * (_1_width);
        }
      }
      {
        if (_source0.is_Square) {
          BigInteger _2_side = _source0.dtor_side;
          return (_2_side) * (_2_side);
        }
      }
      {
        BigInteger _3_base = _source0.dtor_base;
        BigInteger _4_height = _source0.dtor_height;
        return Dafny.Helpers.EuclideanDivision((_3_base) * (_4_height), new BigInteger(2));
      }
    }
    public static BigInteger monthLen(_Imonth m, bool isLeap)
    {
      _Imonth _source0 = m;
      {
      ...
      }
      {
        if (isLeap) {
          ...
          return new BigInteger(28);
        }
      }
    }
    public static bool isLeapYear(BigInteger year) {
      if ((((Dafny.Helpers.EuclideanModulus(year, new BigInteger(4))).Sign == 0) && ((Dafny.Helpers.EuclideanModulus(year, new BigInteger(100))).Sign != 0)) || ((Dafny.Helpers.EuclideanModulus(year, new BigInteger(400))).Sign == 0)) {
        return true;
      } else {
        return false;
      }
    }
    public static BigInteger exp(BigInteger m, BigInteger p)
    {
    ...
    TAIL_CALL_START: ;
      if ((p).Sign == 0) {
        ...
        _0___accumulator = (_0___accumulator) * (m);
        BigInteger _in0 = m;
        BigInteger _in1 = (p) - (BigInteger.One);
        m = _in0;
        p = _in1;
        goto TAIL_CALL_START;
      }
    }
    public static BigInteger gradient(_System._ITuple2<BigInteger, BigInteger> p1, _System._ITuple2<BigInteger, BigInteger> p2)
    {
      return Dafny.Helpers.EuclideanDivision(((p2).dtor__1) - ((p1).dtor__1), ((p2).dtor__0) - ((p1).dtor__0));
    }
    public static BigInteger makeItBigger(BigInteger i) {
      return (i) + (BigInteger.One);
    }
    ...
    public static BigInteger length<__T>(_Ilist<__T> l) {
    ...
    TAIL_CALL_START: ;
      ...
      {
        _Ilist<__T> _1_xs = _source0.dtor_tl;
        return (BigInteger.One) + (__default.length<__T>(_1_xs));
      }
    }
    public static _Ilist<__T> append<__T>(_Ilist<__T> l1, _Ilist<__T> l2)
    {
      _Ilist<__T> _source0 = l1;
      {
        if (_source0.is_Nil) {
          return l2;
        }
      ...
      {
        __T _0_x = _source0.dtor_hd;
        _Ilist<__T> _1_xs = _source0.dtor_tl;
        return _module.list<__T>.create_Cons(_0_x, __default.append<__T>(_1_xs, l2));
      }
    }
    public static bool member(BigInteger x, _Ilist<BigInteger> A)
    {
    TAIL_CALL_START: ;
      _Ilist<BigInteger> _source0 = A;
      {
        if (_source0.is_Nil) {
          return false;
        }
      ...
      {
        BigInteger _0_y = _source0.dtor_hd;
        _Ilist<BigInteger> _1_ys = _source0.dtor_tl;
        if ((x) == (_0_y)) {
          return true;
        } else {
          BigInteger _in0 = x;
          _Ilist<BigInteger> _in1 = _1_ys;
          x = _in0;
          A = _in1;
          goto TAIL_CALL_START;
        }
    ...
    public static BigInteger size<__V>(_Itree<__V> t) {
      ...
      {
        Dafny.ISequence<Dafny.Rune> _0_k = _source0.dtor_key;
        __V _1_v = _source0.dtor_val;
        _Itree<__V> _2_l = _source0.dtor_left;
  ...
  public interface _Ilight {
    bool is_Red { get; }
    bool is_Orange { get; }
    bool is_Green { get; }
    _Ilight DowncastClone();
  }
  public abstract class light : _Ilight {
    public light() {
    }
    private static readonly _Ilight theDefault = create_Red();
    public static _Ilight Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_Ilight> _TYPE = new Dafny.TypeDescriptor<_Ilight>(light.Default());
    public static Dafny.TypeDescriptor<_Ilight> _TypeDescriptor() {
      return _TYPE;
    }
    public static _Ilight create_Red() {
      return new light_Red();
    }
    public static _Ilight create_Orange() {
      return new light_Orange();
    }
    public static _Ilight create_Green() {
      return new light_Green();
    }
    public bool is_Red { get { return this is light_Red; } }
    public bool is_Orange { get { return this is light_Orange; } }
    public bool is_Green { get { return this is light_Green; } }
    public static System.Collections.Generic.IEnumerable<_Ilight> AllSingletonConstructors {
      get {
        yield return light.create_Red();
        yield return light.create_Orange();
        yield return light.create_Green();
      }
    }
    public abstract _Ilight DowncastClone();
  }
  public class light_Red : light {
    public light_Red() : base() {
    }
    public override _Ilight DowncastClone() {
      if (this is _Ilight dt) { return dt; }
      return new light_Red();
    }
    public override bool Equals(object other) {
      var oth = other as light_Red;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public class light_Orange : light {
    public light_Orange() : base() {
    }
    public override _Ilight DowncastClone() {
      if (this is _Ilight dt) { return dt; }
      return new light_Orange();
    ...
    public override string ToString() {
      string s = "light.Orange";
      return s;
    }
  }
  public class light_Green : light {
    public light_Green() : base() {
    }
    public override _Ilight DowncastClone() {
      if (this is _Ilight dt) { return dt; }
      return new light_Green();
    ...
    public override string ToString() {
      string s = "light.Green";
      return s;
    }
  }

  public interface _Ishape {
    bool is_Rectangle { get; }
    bool is_Square { get; }
    bool is_Triangle { get; }
    BigInteger dtor_height { get; }
    BigInteger dtor_width { get; }
    BigInteger dtor_side { get; }
    BigInteger dtor_base { get; }
    _Ishape DowncastClone();
  }
  public abstract class shape : _Ishape {
    public shape() {
    }
    private static readonly _Ishape theDefault = create_Rectangle(BigInteger.Zero, BigInteger.Zero);
    public static _Ishape Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_Ishape> _TYPE = new Dafny.TypeDescriptor<_Ishape>(shape.Default());
    public static Dafny.TypeDescriptor<_Ishape> _TypeDescriptor() {
      return _TYPE;
    }
    public static _Ishape create_Rectangle(BigInteger height, BigInteger width) {
      return new shape_Rectangle(height, width);
    }
    public static _Ishape create_Square(BigInteger side) {
      return new shape_Square(side);
    }
    public static _Ishape create_Triangle(BigInteger @base, BigInteger height) {
      return new shape_Triangle(@base, height);
    }
    public bool is_Rectangle { get { return this is shape_Rectangle; } }
    public bool is_Square { get { return this is shape_Square; } }
    public bool is_Triangle { get { return this is shape_Triangle; } }
    public BigInteger dtor_height {
      get {
        var d = this;
        if (d is shape_Rectangle) { return ((shape_Rectangle)d)._height; }
        return ((shape_Triangle)d)._height;
      }
    }
    public BigInteger dtor_width {
      get {
        var d = this;
        return ((shape_Rectangle)d)._width;
      }
    }
    public BigInteger dtor_side {
      get {
        var d = this;
        return ((shape_Square)d)._side;
      }
    }
    public BigInteger dtor_base {
      get {
        var d = this;
        return ((shape_Triangle)d)._base;
      }
    }
    public abstract _Ishape DowncastClone();
  }
  public class shape_Rectangle : shape {
    public readonly BigInteger _height;
    public readonly BigInteger _width;
    public shape_Rectangle(BigInteger height, BigInteger width) : base() {
      this._height = height;
      this._width = width;
    }
    public override _Ishape DowncastClone() {
      if (this is _Ishape dt) { return dt; }
      return new shape_Rectangle(_height, _width);
    }
    public override bool Equals(object other) {
      var oth = other as shape_Rectangle;
      return oth != null && this._height == oth._height && this._width == oth._width;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
  ...
  public class shape_Square : shape {
    public readonly BigInteger _side;
    public shape_Square(BigInteger side) : base() {
      this._side = side;
    }
    public override _Ishape DowncastClone() {
      if (this is _Ishape dt) { return dt; }
      return new shape_Square(_side);
    }
    public override bool Equals(object other) {
      var oth = other as shape_Square;
      return oth != null && this._side == oth._side;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._side));
      return (int) hash;
    }
    public override string ToString() {
      string s = "shape.Square";
      s += "(";
      s += Dafny.Helpers.ToString(this._side);
      s += ")";
      return s;
    }
  }
  public class shape_Triangle : shape {
    public readonly BigInteger _base;
    public readonly BigInteger _height;
    public shape_Triangle(BigInteger @base, BigInteger height) : base() {
      this._base = @base;
      this._height = height;
    }
    public override _Ishape DowncastClone() {
      if (this is _Ishape dt) { return dt; }
      return new shape_Triangle(_base, _height);
    }
    public override bool Equals(object other) {
      var oth = other as shape_Triangle;
      return oth != null && this._base == oth._base && this._height == oth._height;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 2;
  ...
  public interface _Imonth {
    ...
    bool is_Nov { get; }
    bool is_Dec { get; }
    _Imonth DowncastClone();
  }
  public abstract class month : _Imonth {
    public month() {
    }
    private static readonly _Imonth theDefault = create_Jan();
    public static _Imonth Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_Imonth> _TYPE = new Dafny.TypeDescriptor<_Imonth>(month.Default());
    public static Dafny.TypeDescriptor<_Imonth> _TypeDescriptor() {
      return _TYPE;
    }
    public static _Imonth create_Jan() {
      return new month_Jan();
    }
    public static _Imonth create_Feb() {
      return new month_Feb();
    }
    public static _Imonth create_Mar() {
      return new month_Mar();
    }
    public static _Imonth create_Apr() {
      return new month_Apr();
    }
    public static _Imonth create_May() {
      return new month_May();
    }
    public static _Imonth create_Jun() {
      return new month_Jun();
    }
    public static _Imonth create_Jul() {
      return new month_Jul();
    }
    public static _Imonth create_Aug() {
      return new month_Aug();
    }
    public static _Imonth create_Sep() {
      return new month_Sep();
    }
    public static _Imonth create_Oct() {
      return new month_Oct();
    }
    public static _Imonth create_Nov() {
      return new month_Nov();
    }
    public static _Imonth create_Dec() {
      return new month_Dec();
    }
    public bool is_Jan { get { return this is month_Jan; } }
    public bool is_Feb { get { return this is month_Feb; } }
    public bool is_Mar { get { return this is month_Mar; } }
    public bool is_Apr { get { return this is month_Apr; } }
    public bool is_May { get { return this is month_May; } }
    public bool is_Jun { get { return this is month_Jun; } }
    public bool is_Jul { get { return this is month_Jul; } }
    public bool is_Aug { get { return this is month_Aug; } }
    public bool is_Sep { get { return this is month_Sep; } }
    public bool is_Oct { get { return this is month_Oct; } }
    public bool is_Nov { get { return this is month_Nov; } }
    public bool is_Dec { get { return this is month_Dec; } }
    public static System.Collections.Generic.IEnumerable<_Imonth> AllSingletonConstructors {
      get {
        yield return month.create_Jan();
        yield return month.create_Feb();
        yield return month.create_Mar();
        yield return month.create_Apr();
        yield return month.create_May();
        yield return month.create_Jun();
        yield return month.create_Jul();
        yield return month.create_Aug();
        yield return month.create_Sep();
        yield return month.create_Oct();
        yield return month.create_Nov();
        yield return month.create_Dec();
      }
    }
    public abstract _Imonth DowncastClone();
  }
  public class month_Jan : month {
    public month_Jan() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Jan();
    }
    public override bool Equals(object other) {
      var oth = other as month_Jan;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public class month_Feb : month {
    public month_Feb() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Feb();
  ...
  public class month_Mar : month {
    public month_Mar() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Mar();
  ...
  public class month_Apr : month {
    public month_Apr() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Apr();
  ...
  public class month_May : month {
    public month_May() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_May();
  ...
  public class month_Jun : month {
    public month_Jun() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Jun();
  ...
  public class month_Jul : month {
    public month_Jul() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Jul();
  ...
  public class month_Aug : month {
    public month_Aug() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Aug();
  ...
  public class month_Sep : month {
    public month_Sep() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Sep();
  ...
  public class month_Oct : month {
    public month_Oct() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Oct();
  ...
  public class month_Nov : month {
    public month_Nov() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Nov();
  ...
  public class month_Dec : month {
    public month_Dec() : base() {
    }
    public override _Imonth DowncastClone() {
      if (this is _Imonth dt) { return dt; }
      return new month_Dec();
  ...
  public abstract class list<T> : _Ilist<T> {
    ...
    public static _Ilist<T> create_Cons(T hd, _Ilist<T> tl) {
    ...
    public T dtor_hd {
      get {
        var d = this;
        return ((list_Cons<T>)d)._hd;
      }
    }
    public _Ilist<T> dtor_tl {
      get {
        var d = this;
        return ((list_Cons<T>)d)._tl;
      }
    }
  ...
  public class list_Cons<T> : list<T> {
    public readonly T _hd;
    public readonly _Ilist<T> _tl;
    public list_Cons(T hd, _Ilist<T> tl) : base() {
      this._hd = hd;
      this._tl = tl;
    }
    public override _Ilist<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      if (this is _Ilist<__T> dt) { return dt; }
      return new list_Cons<__T>(converter0(_hd), (_tl).DowncastClone<__T>(Dafny.Helpers.CastConverter<T, __T>));
    }
    public override bool Equals(object other) {
      var oth = other as list_Cons<T>;
      return oth != null && object.Equals(this._hd, oth._hd) && object.Equals(this._tl, oth._tl);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._hd));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._tl));
      return (int) hash;
    }
    public override string ToString() {
      string s = "list.Cons";
      s += "(";
      s += Dafny.Helpers.ToString(this._hd);
      s += ", ";
      s += Dafny.Helpers.ToString(this._tl);
      s += ")";
      return s;
    }
  }
  ...
  public interface _Itree<V> {
    bool is_Lf { get; }
    bool is_Node { get; }
    Dafny.ISequence<Dafny.Rune> dtor_key { get; }
    V dtor_val { get; }
    _Itree<V> dtor_left { get; }
    _Itree<V> dtor_right { get; }
    _Itree<__V> DowncastClone<__V>(Func<V, __V> converter0);
  }
  public abstract class tree<V> : _Itree<V> {
    public tree() {
    }
    public static _Itree<V> Default() {
      return create_Lf();
    }
    public static Dafny.TypeDescriptor<_Itree<V>> _TypeDescriptor() {
      return new Dafny.TypeDescriptor<_Itree<V>>(tree<V>.Default());
    }
    public static _Itree<V> create_Lf() {
      return new tree_Lf<V>();
    }
    public static _Itree<V> create_Node(Dafny.ISequence<Dafny.Rune> key, V val, _Itree<V> left, _Itree<V> right) {
      return new tree_Node<V>(key, val, left, right);
    }
    public bool is_Lf { get { return this is tree_Lf<V>; } }
    public bool is_Node { get { return this is tree_Node<V>; } }
    public Dafny.ISequence<Dafny.Rune> dtor_key {
      get {
        var d = this;
        return ((tree_Node<V>)d)._key;
      }
    }
    public V dtor_val {
      get {
        var d = this;
        return ((tree_Node<V>)d)._val;
      }
    }
    public _Itree<V> dtor_left {
      get {
        var d = this;
        return ((tree_Node<V>)d)._left;
      }
    }
    public _Itree<V> dtor_right {
      get {
        var d = this;
        return ((tree_Node<V>)d)._right;
      }
    }
    public abstract _Itree<__V> DowncastClone<__V>(Func<V, __V> converter0);
  }
  public class tree_Lf<V> : tree<V> {
    public tree_Lf() : base() {
    }
    public override _Itree<__V> DowncastClone<__V>(Func<V, __V> converter0) {
      if (this is _Itree<__V> dt) { return dt; }
      return new tree_Lf<__V>();
    }
    public override bool Equals(object other) {
      var oth = other as tree_Lf<V>;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public class tree_Node<V> : tree<V> {
    public readonly Dafny.ISequence<Dafny.Rune> _key;
    public readonly V _val;
    public readonly _Itree<V> _left;
    public readonly _Itree<V> _right;
    public tree_Node(Dafny.ISequence<Dafny.Rune> key, V val, _Itree<V> left, _Itree<V> right) : base() {
      this._key = key;
      this._val = val;
      this._left = left;
      this._right = right;
    ...
    public override _Itree<__V> DowncastClone<__V>(Func<V, __V> converter0) {
      if (this is _Itree<__V> dt) { return dt; }
      return new tree_Node<__V>(_key, converter0(_val), (_left).DowncastClone<__V>(Dafny.Helpers.CastConverter<V, __V>), (_right).DowncastClone<__V>(Dafny.Helpers.CastConverter<V, __V>));
    }
    public override bool Equals(object other) {
      var oth = other as tree_Node<V>;
      return oth != null && object.Equals(this._key, oth._key) && object.Equals(this._val, oth._val) && object.Equals(this._left, oth._left) && object.Equals(this._right, oth._right);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
    ...
    public override string ToString() {
      string s = "tree.Node";
      s += "(";
      s += this._key.ToVerbatimString(true);
      s += ", ";
